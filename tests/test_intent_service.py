...
from appointment_agent.services.intent import (
...
@patch("appointment_agent.services.intent.requests.post")
...
@patch("appointment_agent.services.intent.send_reformulation_prompt")
...
@patch("appointment_agent.services.intent.reformulate_with_explicit_date")
